...
import { matchApartment } from '@/api/modelsServices/apartments-service.ts';
...
export const ApartmentData: React.FC<IApartmentDataProps> = ({ apartment, apartmentId, isCreatedByUser }) => {
  ...
  const fetchMatchingList = async () => {
    const matchingListFromBE = await api.apartment.getMatchingList(apartmentId);
      ...
      setIsAccepted(matchingList.some((match) => match.user._id === localStorage.getItem('userId') && match.accepted))
  }
  ...
  return (
    <>
      ...
      {isCreatedByUser && <h3> Interested Clients</h3>}
      {isCreatedByUser && matchingList.map(matching => (
        <div data-auto="leads-form" className="css-rlze51 e1g5ext0">
          <div className="css-1p5re2e e1g5ext2">
            <div className="css-17hovo1 e1siqbpd0">
              <div
            ...
            <div className="css-17hovo1 e1siqbpd0">
              <div className="css-1cmihl8 e1siqbpd2">
                ...
                >
                  {!matching.accepted ?
                    <Button onClick={() => acceptMatch(matching._id!)}>Continue With Client</Button>
                  : 'Accepted'}
                </div>
              </div>
            </div>
