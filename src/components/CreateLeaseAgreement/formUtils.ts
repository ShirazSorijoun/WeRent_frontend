...
export const leaseAgreementFormDataObject: Record<ELeaseAgreementFields, IFormField> = {
...
export const schema = z.object({
    ...
    [ELeaseAgreementFields.OPTION_PERIOD]: z.enum(['Yes', 'No']),
    ...
    [ELeaseAgreementFields.MAX_NUM_OF_MONTHS_INCLUDE_OPTION_PERIOD]: z.number().int().optional(),
    [ELeaseAgreementFields.NUM_OF_DAYS_FOR_REPAIR]: z.number().int(),
    [ELeaseAgreementFields.SUBTENANT]: z.enum(['Yes', 'No']),
    [ELeaseAgreementFields.NUM_OF_DAYS_PAYMENT_DELAY]: z.number().int(),
    [ELeaseAgreementFields.PROMISSORY_NOTE]: z.enum(['Yes', 'No']),
    [ELeaseAgreementFields.PROMISSORY_NOTE_AMOUNT]: z.number().optional(),
    [ELeaseAgreementFields.LETTER_OF_GUARANTEE]: z.enum(['Yes', 'No']),
    [ELeaseAgreementFields.GUARANTEE]: z.enum(['Financial deposit', 'Autonomous bank guarantee']).optional(),
    [ELeaseAgreementFields.GUARANTEE_AMOUNT]: z.number().optional(),
    [ELeaseAgreementFields.ANIMAL]: z.enum(['Yes', 'No']),
});
